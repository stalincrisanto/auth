...
export class MongoDbAdapter {
  ...
  async upsert(id: string, payload: any, expiresIn: number): Promise<any> {
    console.log(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
    console.log(this.model, "upsert =>", id)
    console.log("payload in upsert =>", payload)
    console.log("<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<\n")
  ...
  async find(id: string): Promise<any> {
    console.log(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
    console.log(this.model, "find =>", id)
  ...
  async findByUserCode(userCode: string): Promise<any> {
    console.log(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
    console.log(this.model, "findByUserCode =>", userCode)
    ...
    console.log("payload found => ", doc.payload)
    console.log("<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<\n")
  ...
  async findByUid(uid: string): Promise<any> {
    console.log(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
    console.log(this.model, "findByUid =>", uid)
  ...
  async consume(id: string): Promise<any> {
    console.log(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
    console.log(this.model, "consume =>", id)
    console.log("<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<\n")
  ...
  async destroy(id: string): Promise<any> {
    console.log(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
    console.log(this.model, "destroy =>", id)
    console.log("<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<\n")
  ...
  async revokeByGrantId(grantId: string): Promise<any> {
    console.log(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
    console.log(this.model, "revokeByGrantId =>", grantId)
    console.log("<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<\n")
